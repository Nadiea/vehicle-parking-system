...
if(isset($_POST['submit']))
 ...
 $eid=$_GET['editid'];
    ...
    $query=mysqli_query($con, "update  tblservices set vehicle='$vehicle',charge='$charge' where ID='$eid' ");
    if ($query) {
    $msg="charge has been Updated.";
  }
  else
    {
...
<!--//webfonts--> 
<!--animate-->
<link href="csss/animate.css" rel="stylesheet" type="text/css" media="all">
